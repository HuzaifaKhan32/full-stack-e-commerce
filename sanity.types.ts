...
// Query: *[_type == "product" && status == "hot"] | order(name desc){    ...,"categories":categories[]->title  }
...
// Variable: SLUG_BRAND_QUERY
// Query: *[_type == "product" && slug.current == $slug]{    "brandName": brand->title    }
export type SLUG_BRAND_QUERYResult = Array<{
